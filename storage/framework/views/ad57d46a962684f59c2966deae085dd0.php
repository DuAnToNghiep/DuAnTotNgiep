    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('fabrics.update', $fabric->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="update_date" name="update_date" value="<?php echo e($fabric->update_date); ?>" disabled>
            </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\New folder\vidu1\resources\views/admin/fabrics/edit.blade.php ENDPATH**/ ?>