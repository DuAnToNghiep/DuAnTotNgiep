...
<head>
    ...
    <!-- Title -->
    <title>Dự án tốt nghiệp WD-11</title>
    ...
    <!-- CSS Front Template -->
    <link rel="stylesheet" href="<?php echo e(asset("assets")); ?>\css\theme.min.css?v=1.0">
</head>

<body class="   footer-offset">

<script src="<?php echo e(asset("assets")); ?>\vendor\hs-navbar-vertical-aside\hs-navbar-vertical-aside-mini-cache.js"></script>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\layouts-sidebar-default.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\layouts-sidebar-dark.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\layouts-sidebar-light.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\sidebar-default-classic.svg" alt="Image Description">
                            </label>
                            <span class="custom-checkbox-card-text">Default</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\sidebar-compact.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\sidebar-mini.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\header-default-fluid.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\header-default-container.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\header-double-line-fluid.svg" alt="Image Description">
                            </label>
                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                                <img class="custom-checkbox-card-img" src="<?php echo e(asset("assets")); ?>\svg\layouts\header-double-line-container.svg" alt="Image Description">
                            </label>
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="index.html" aria-label="Front">
                    <img class="navbar-brand-logo" src="<?php echo e(asset("assets")); ?>\svg\logos\logo.svg" alt="Logo">
                    <img class="navbar-brand-logo-mini" src="<?php echo e(asset("assets")); ?>\svg\logos\logo-short.svg" alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
                ...
                <span class="h4 mr-1">
                  ...
                  <span class="icon icon-xs icon-soft-dark icon-circle mr-2">
                    <i class="tio-paint-bucket"></i>
                                ...
                                <a class="dropdown-item my-2" href="index.html">
                                    <div class="media align-items-center">
                                        <img class="avatar avatar-xs avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\img\160x160\img10.jpg" alt="Image Description">
                                        <div class="media-body text-truncate">
                                ...
                                <a class="dropdown-item my-2" href="index.html">
                                    <div class="media align-items-center">
                                        <img class="avatar avatar-xs avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\img\160x160\img3.jpg" alt="Image Description">
                                        <div class="media-body text-truncate">
            ...
            <div class="navbar-nav-wrap-content-right">
                                                        ...
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img3.jpg" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col ml-n3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img10.jpg" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col ml-n3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\svg\brands\google.svg" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col ml-n3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img7.jpg" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col ml-n3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img5.jpg" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col ml-n3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-auto position-static">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="avatar avatar-sm avatar-circle">
                                                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img8.jpg" alt="Image Description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col ml-n3">
                                ...
                                <div class="card-body card-body-height">
                                    ...
                                    <div class="nav nav-pills flex-column">
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\brands\atlassian.svg" alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\brands\slack.svg" alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\brands\google-webdev.svg" alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\brands\frontapp.svg" alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <a class="nav-link" href="#">
                                            <div class="media align-items-center">
                      <span class="mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\illustrations\review-rating-shield.svg" alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                ...
                "smartPositionOff": true
                 ...
                 "type": "css-animation"
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img6.jpg" alt="Image Description">
            ...
            <div class="container-fluid">
                <div class="navbar-nav-wrap">
                    <div class="navbar-brand-wrapper">
                        <!-- Logo -->
                        <a class="navbar-brand" href="index.html" aria-label="Front">
                            <img class="navbar-brand-logo" src="<?php echo e(asset("assets")); ?>\svg\logos\logo-white.svg" alt="Logo">
                        </a>
                        <!-- End Logo -->
                    </div>
                                        ...
                                        <div class="card-body card-body-height">
                                            ...
                                            <div class="nav nav-pills flex-column">
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="<?php echo e(asset("assets")); ?>\svg\brands\atlassian.svg" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">Atlassian</span>
                                                            <span class="d-block font-size-sm text-body">Security and control across Cloud</span>
                                                ...
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="<?php echo e(asset("assets")); ?>\svg\brands\slack.svg" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">Slack <span class="badge badge-primary badge-pill text-uppercase ml-1">Try</span></span>
                                                            <span class="d-block font-size-sm text-body">Email collaboration software</span>
                                                ...
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="<?php echo e(asset("assets")); ?>\svg\brands\frontapp.svg" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">Frontapp</span>
                                                            <span class="d-block font-size-sm text-body">The inbox for teams</span>
                                                ...
                                                <a class="nav-link" href="#">
                                                    <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="<?php echo e(asset("assets")); ?>\svg\illustrations\review-rating-shield.svg" alt="Image Description">
                          </span>
                                                        <div class="media-body text-truncate">
                                                            <span class="h5 mb-0">HS Support</span>
                                                            <span class="d-block font-size-sm text-body">Customer service and support</span>
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu show">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?php echo e(url('/admin/')); ?>" title="Default">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Quay Lại Trang chủ</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?php echo e(url('/admin/')); ?>" title="Default">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Quay Lại Khách Hàng</span>
                                    </a>
                                </li>
                        ...
                        <?php echo $__env->make('admin.layouts.pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                        <!-- End Pages -->

                        <!-- Apps -->

                        <?php echo $__env->make('admin.layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!-- End Apps -->

                        <!-- Authentication -->

                        <?php echo $__env->make('admin.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!-- End Authentication -->
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="English (US)">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\vendor\flag-icon-css\flags\1x1\us.svg" alt="Flag">
                                        English (US)
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="English (UK)">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\vendor\flag-icon-css\flags\1x1\gb.svg" alt="Flag">
                                        English (UK)
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="Deutsch">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\vendor\flag-icon-css\flags\1x1\de.svg" alt="Flag">
                                        Deutsch
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="Dansk">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\vendor\flag-icon-css\flags\1x1\dk.svg" alt="Flag">
                                        Dansk
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="Italiano">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\vendor\flag-icon-css\flags\1x1\it.svg" alt="Flag">
                                        Italiano
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="中文 (繁體)">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?php echo e(asset("assets")); ?>\vendor\flag-icon-css\flags\1x1\cn.svg" alt="Flag">
                                        中文 (繁體)
                                    </a>
                                </li>
                            </ul>
...
<div id="sidebarCompact" class="d-none"><aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            <div class="navbar-brand d-flex justify-content-center">
                ...
                <a class="navbar-brand" href="index.html" aria-label="Front">
                    <img class="navbar-brand-logo-short" src="<?php echo e(asset("assets")); ?>\svg\logos\logo-short.svg" alt="Logo">
                </a>
            ...
            <!-- Content -->
            <div class="navbar-vertical-content<ul class="navbar-nav nav-compact">
                    <!-- Dashboards -->
...
<main id="content" role="main" class="main pointer-event">
    ...
    <div class="footer">
        <div class="row justify-content-between align-items-center">
            <div class="col">
                <p class="font-size-sm mb-0">&copy; WD-11. <span class="d-none d-sm-inline-block">2024.Thời trang Golden Era</span></p>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body sidebar-body sidebar-scrollbar">
            ...
            <ul class="step step-icon-sm step-avatar-sm">
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img9.jpg" alt="Image Description">
                        </div>
                        ...
                        <div class="step-content">
                            ...
                            <ul class="list-group list-group-sm">
                              ...
                              <span class="mt-1 mr-2">
                                <img class="avatar avatar-xs" src="<?php echo e(asset("assets")); ?>\svg\brands\excel.svg" alt="Image Description">
                              </span>
                                                <div class="media-body text-truncate">
                                        ...
                                        <div class="col-6">
                                            <div class="media">
                              <span class="mt-1 mr-2">
                                <img class="avatar avatar-xs" src="<?php echo e(asset("assets")); ?>\svg\brands\word.svg" alt="Image Description">
                              </span>
                                                <div class="media-body text-truncate">
                                                    <span class="d-block font-size-sm text-dark text-truncate" title="weekly-reports.xls">weekly-reports.xls</span>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img3.jpg" alt="Image Description">
                        </div>
                        ...
                        <div class="step-content">
                            ...
                            <ul class="list-group list-group-sm">
                                <li class="list-group-item list-group-item-light">
                                    <div class="row gx-1">
                                        <div class="col">
                                            <img class="img-fluid rounded ie-sidebar-activity-img" src="<?php echo e(asset("assets")); ?>\svg\illustrations\card-1.svg" alt="Image Description">
                                        </div>
                                        <div class="col">
                                            <img class="img-fluid rounded ie-sidebar-activity-img" src="<?php echo e(asset("assets")); ?>\svg\illustrations\card-2.svg" alt="Image Description">
                                        </div>
                                        <div class="col">
                                            <img class="img-fluid rounded ie-sidebar-activity-img" src="<?php echo e(asset("assets")); ?>\svg\illustrations\card-3.svg" alt="Image Description">
                                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img7.jpg" alt="Image Description">
                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img5.jpg" alt="Image Description">
                        </div>
            ...
            <div class="modal-body p-sm-5">
                <div class="text-center">
                    <div class="w-75 w-sm-50 mx-auto mb-4">
                        <img class="img-fluid" src="<?php echo e(asset("assets")); ?>\svg\illustrations\graphs.svg" alt="Image Description">
                    </div>
            ...
            <div class="modal-footer d-block text-center py-sm-5">
                ...
                <div class="w-85 mx-auto">
                    <div class="row justify-content-between">
                        <div class="col">
                            <img class="img-fluid ie-welcome-brands" src="<?php echo e(asset("assets")); ?>\svg\brands\gitlab-gray.svg" alt="Image Description">
                        </div>
                        <div class="col">
                            <img class="img-fluid ie-welcome-brands" src="<?php echo e(asset("assets")); ?>\svg\brands\fitbit-gray.svg" alt="Image Description">
                        </div>
                        <div class="col">
                            <img class="img-fluid ie-welcome-brands" src="<?php echo e(asset("assets")); ?>\svg\brands\flow-xo-gray.svg" alt="Image Description">
                        </div>
                        <div class="col">
                            <img class="img-fluid ie-welcome-brands" src="<?php echo e(asset("assets")); ?>\svg\brands\layar-gray.svg" alt="Image Description">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-auto">
                        <a class="d-flex align-items-center font-size-sm text-body" href="#">
                            <img class="avatar avatar-xss mr-2" src="<?php echo e(asset("assets")); ?>\svg\brands\gmail.svg" alt="Image Description">
                            Import contacts
                        </a>
                    </div>
                </div>
                ...
                <ul class="list-unstyled list-unstyled-py-4">
                    ...
                    <li>
                        <div class="media">
                            <div class="avatar avatar-sm avatar-circle mr-3">
                                <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img9.jpg" alt="Image Description">
                            </div>
...
<script src="<?php echo e(asset("assets")); ?>\vendor\chart.js.extensions\chartjs-extensions.js"></script>
<script src="<?php echo e(asset("assets")); ?>\vendor\chartjs-plugin-datalabels\dist\chartjs-plugin-datalabels.min.js"></script>



<!-- JS Front -->
<script src="<?php echo e(asset("assets")); ?>\js\theme.min.js"></script>
...
<?php /**PATH C:\laragon\www\New folder\DuAnTotNgiep\resources\views/admin/master.blade.php ENDPATH**/ ?>