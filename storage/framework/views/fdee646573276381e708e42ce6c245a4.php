                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush list-group-no-gutters">
                            ...
                            <li class="list-group-item py-3">
                                <div class="media">
                                    <div class="mt-1 mr-3">
                                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\brands\capsule.svg" alt="Image Description">
                                    </div>
                            ...
                            <li class="list-group-item py-3">
                                <div class="media">
                                    <div class="mt-1 mr-3">
                                        <img class="avatar avatar-xs avatar-4by3" src="<?php echo e(asset("assets")); ?>\svg\brands\mailchimp.svg" alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                ...
                <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                    ...
                    <tr>
                        ...
                        <td class="table-column-pl-0">
                            <a class="media align-items-center" href="user-profile.html">
                                <div class="avatar avatar-sm avatar-circle mr-2">
                                    <img class="avatar-img" src="<?php echo e(asset("assets")); ?>\img\160x160\img4.jpg" alt="Image Description">
                                </div>
                                <div class="media-body">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\New folder\DuAnTotNgiep\resources\views/admin/index.blade.php ENDPATH**/ ?>