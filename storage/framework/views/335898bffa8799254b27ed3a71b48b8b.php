    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('images.update', $image->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="create_date" name="create_date" value="<?php echo e($image->create_date); ?>" disabled>
            </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\New folder\DuAnTotNgiep\resources\views/admin/images/edit.blade.php ENDPATH**/ ?>